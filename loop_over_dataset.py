...
data_fullpath = f"/Users/panyr/SandBox/PlayGround/udacity/Self-Driving-Car-Engineer/3-Sensor-Fusion/dataset/{data_filename}"

results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results')
# results_fullpath = f"/Users/panyr/SandBox/PlayGround/udacity/Self-Driving-Car-Engineer/3-Sensor-Fusion-MIDTERM/results"
